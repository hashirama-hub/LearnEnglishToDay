...
class ExpandableListData{
    public  static HashMap <String, List<String>> getData(){
        ...
        englishTenses.add("Present Simple/Hiện tại đơn");
        englishTenses.add("Present Continuous/Hiện tại tiếp diễn");
        englishTenses.add("Past Simple/Quá khứ đơn");
        englishTenses.add("Past Continuous/Quá khứ tiếp diễn");
        englishTenses.add("Future Simple/Tương lai đơn");
        englishTenses.add("Future Continuous/Tương lai tiếp diễn");
        englishTenses.add("Present Perfect Simple/Hiện tại hoàn thành");
        englishTenses.add("Present Perfect Continuous/Hiện tại hoàn thành tiếp diễn");
        englishTenses.add("Past Perfect/Quá khứ hoàn thành");
        englishTenses.add("Past Perfect Continuous/Quá khứ hoàn thành tiếp diễn");
        englishTenses.add("Future Perfect/Tương lai hoàn thành");
        englishTenses.add("Future Perfect Continuous/Tương lai hoàn thành tiếp diễn");
        ...
        idioms.add("Idioms Metaphors and Similes/Thành ngữ ẩn dụ và so sánh");

        List<String> relativeClauses = new ArrayList<String>();
        relativeClauses.add("Define Relative Clauses/Mệnh đề quan hệ xác định");
        relativeClauses.add("Non-Define Relative Clauses/Mệnh đề quan hệ không xác định");
        ...
        conditionals.add("Zero Conditional/Câu điều kiện loại 0");
        conditionals.add("1st Conditional/Câu điều kiện loại 1");
        conditionals.add("2nd Conditional/Câu điều kiện loại 2");
        conditionals.add("3rd Conditional/Câu điều kiện loại 3");
        conditionals.add("Mix Conditional/Câu điều kiện hỗn hợp");

        List<String> ReportedSpeech = new ArrayList<>();
        ReportedSpeech.add("Direct,Indirect Speech/Lời nói trực tiếp, gián tiếp");
        ReportedSpeech.add("Reporting Questions/Câu hỏi tường thuật");
        ReportedSpeech.add("Reporting Commands,Request/Câu yêu cầu, đề nghị");

        List<String> infinitivesGerund = new ArrayList<>();
        infinitivesGerund.add("Infinitives or Gerund/Động từ nguyên mẫu hoặc Danh động từ");

        List<String> verbs = new ArrayList<>();
        verbs.add("Full Verb/Động từ");
        verbs.add("Auxiliary Verbs/Trợ động từ");
        verbs.add("Modal Auxiliary Verbs/Động từ khiếm khuyết");

        List<String> articles = new ArrayList<>();
        articles.add("Definite & Indefinite Article/Mạo từ xác định và không xác định");

        List<String> possessives = new ArrayList<>();
        possessives.add("Adjectives & Pronoun/ Tính từ & Đại từ");


        List<String> partsofSpeech= new ArrayList<String>();
            partsofSpeech.add("Verb, Noun, Pronoun, Adjective,.../Động từ, Danh từ, Đại từ, Tính từ,...");
        List<String> usemanual = new ArrayList<>();
        usemanual.add("User manual/Hướng dẫn sử dụng");
        ...
        expandableList.put("PARTS OF SPEECH/CÁC PHẦN CỦA BÀI PHÁT BIỂU", partsofSpeech);
        expandableList.put("TWELVE VERB TENSES/12 THÌ CƠ BẢN", englishTenses);
        expandableList.put("ARTICLES/MẠO TỪ", relativeClauses);
        expandableList.put("POSSESSIVES/SỞ HỮU CÁCH", possessives);
        expandableList.put("CONDITIONALS/CÂU ĐIỀU KIỆN", conditionals);
        expandableList.put("INFINITIVE & GERUNDS/ĐỘNG TỪ NGUYÊN MẪU VÀ DANH ĐỘNG TỪ", infinitivesGerund);
        expandableList.put("RELATIVE CLAUSES/MỆNH ĐỀ QUAN HỆ", relativeClauses);
        expandableList.put("REPORTED SPEECH/CÂU TƯỜNG THUẬT", ReportedSpeech);
        expandableList.put("VERBS/ĐỘNG TỪ", verbs);
        expandableList.put("IDIOMS/THÀNH NGỮ", idioms);
        expandableList.put("USER MANUAL/HƯỚNG DẪN SỬ DỤNG", usemanual);
        expandableList.put("GRAMMAR TESTS/KIỂM TRA NGỮ PHÁP", englishGrammarTest);
